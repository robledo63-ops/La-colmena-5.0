...
# Definimos la función que CrewAI buscará al arrancar
def run():
    # El modelo usa la llave que configuraste en la plataforma
    llm = ChatGroq(
    ...
    tarea = Task(
        description='Crear una guía para conectar WhatsApp con n8n.',
